...
export default function MyPods() {
  ...
  const fetchMyPods = async () => {
    try {
      const response = await fetch('/api/pods/mine');
      ...
      <main className="md:ml-64 p-6 md:p-8">
        <div className="max-w-6xl mx-auto">
          <div className="flex items-center justify-between mb-8">
            <div>
              <h1 className="text-3xl md:text-4xl font-bold text-gray-900 mb-2">My Pods</h1>
              <p className="text-gray-600">Teams you've created or joined</p>
            </div>
            <button
          ...
          {loading ? (
            ...
            <div className="text-center py-16 bg-white rounded-xl shadow-md">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-2">No pods yet</h3>
              <p className="text-gray-600 mb-6">Create your first pod or browse available ones to join</p>
